...
![system architecture](https://github.com/RichardLin8331/simple_stock_price_prediction_website/blob/main/docs/imgs/System_Architecture.png?raw=true)
...
+ Vue.js 2.7.16
+ Bootstrap-vue
![Web UI](https://github.com/RichardLin8331/simple_stock_price_prediction_website/blob/main/docs/imgs/WebUI.png?raw=true)
### Deployment
